...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.root.geometry("620x720+400+100")
        self.root.config(bg = 'green')


        self.MainFrame = Frame(self.root , bd =18, width = 640, height = 700, relief=RIDGE, bg = 'green')
        self.MainFrame.grid()
        self.WidgetFrame = Frame(self.MainFrame , bd =18, width = 590, height = 690, relief=RIDGE, bg = 'blue')
    ...
    def create_button(self, text, row, column):
        btnWidget = Button(self.WidgetFrame, width = 6, text = text, height = 2, bd = 4, bg='blue', font =('arial', 20, 'bold'),
    ...
    def Button_click(self, text):
        ...
        if text == "←":
            ...
            try:
                ...
                self.input_button = "Not Executable"
